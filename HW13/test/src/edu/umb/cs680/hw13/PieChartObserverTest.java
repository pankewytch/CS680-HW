...
public class PieChartObserverTest {
    ...
    @Test
    public void CreatingInstanceOfPieChartAndVerifyingWithInstanceOf() {
        PieChartObserver cut = new PieChartObserver();
        assertTrue(cut instanceof PieChartObserver);
    }

    @Test
    public void VerifyingChangesMadeToStockTickerMapInPieChart() {
        PieChartObserver cut = new PieChartObserver();
    ...
    @Test
    public void VerifyingChangesMadeToDJIAListInPieChart() {
        PieChartObserver cut = new PieChartObserver();
    ...
    @Test
    public void VerifyPieChartWorksIfInMultipleObservables() {
        PieChartObserver cut = new PieChartObserver();
        stockQuoteObservable.addObserver(cut);
        djiaQuoteObservable.addObserver(cut);
        stockQuoteObservable.changeQuote("test1", 20f);
